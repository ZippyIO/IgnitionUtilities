...
public class guiMachinePurifier extends GuiBase{

	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("textures/gui/container/furnace.png");
	private TileEntityMachinePurifier tileFurnace;

	public guiMachinePurifier(InventoryPlayer invPlayer, TileEntityMachinePurifier tile) {
		super(new ContainerMachinePurifier(invPlayer, tile));
