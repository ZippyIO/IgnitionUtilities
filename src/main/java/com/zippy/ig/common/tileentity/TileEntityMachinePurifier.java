...
import com.zippy.ig.common.recipe.PurifierRecipes;
...
public class TileEntityMachinePurifier extends TileEntity implements ISidedInventory, IRedstoneCache
{
    ...
    {
        return this.hasCustomInventoryName() ? this.field_145958_o : "container.purifier";
    }
    ...
    {
        return this.furnaceCookTime * p_145953_1_ / 35;
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                machinePurifier.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    public static int getItemBurnTime(ItemStack p_145952_0_)
    {
        ...
        else
        {
            ...
            if (item == IGItems.Colanite) return 5000;
