...
public class MicroCableBig extends TMultiPart implements IPowerConductor, JNormalOcclusion, ISidedHollowConnect, IUpdatedEntity{
	...
	public Iterable<ItemStack> getDrops() {
		...
		items.add(new ItemStack(MicroRegistry.FluxCable));
		return items;
	}
	...
	public ItemStack pickItem(MovingObjectPosition hit) {
		...
		return new ItemStack(MicroRegistry.FluxCable);
	}
	...
	public String getType() {
		return MicroRegistry.FluxCable.getUnlocalizedName();
	}
	...
	public void updateConnections(){
		...
		for(ForgeDirection o : ForgeDirection.VALID_DIRECTIONS){
			...
			boolean b = false;
			TileEntity tile = IGL_Utils.getRelative(tile(), o);
