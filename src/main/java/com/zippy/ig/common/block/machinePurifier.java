...
public class machinePurifier extends BlockContainer
{
	...
	public machinePurifier(boolean isActive) {
		super(Material.rock);
		isBurning2 = isActive;
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
		player.openGui(IGMod.instance, 1, world, x, y, z);
		return true;
	}

	public Item getItemDropped(int par1, Random random, int par3) {
		return Item.getItemFromBlock(IGBlocks.machinePurifier);
	}
...
//}
	public static void updateBlockState(boolean burning, World world, int x, int y, int z) {
		...
		if (burning) {
			world.setBlock(x, y, z, IGBlocks.machinePurifierActive);
		} else {
			world.setBlock(x, y, z, IGBlocks.machinePurifier);
		}
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int meta) {
		if (!isBurning) {
			TileEntityMachinePurifier tileentityleadfurnace = (TileEntityMachinePurifier) world.getTileEntity(x, y, z);
