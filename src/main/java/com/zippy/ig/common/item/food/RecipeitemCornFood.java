package com.zippy.ig.common.item.food;
...
public class RecipeitemCornFood extends ItemFood implements IPlantable {
    ...
    public RecipeitemCornFood(int parHealAmount, float parSaturationModifier, 
