...
import com.zippy.ig.common.machine.ConfigurableMachineWithInventory;
import com.zippy.ig.common.machine.MachineData;
...
public class TileSteamGenerator extends ConfigurableMachineWithInventory implements IUpdatedEntity{
	...
	public TileSteamGenerator(){
		super(1,"Generator",MachineData.SteamGenerator);
	}
