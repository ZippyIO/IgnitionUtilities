...
public class GuiPulverizier extends GuiContainer {
    private TilePulverizier tileEntity;
    
    public GuiPulverizier(InventoryPlayer InventoryPlayer, TilePulverizier parTileEntity) {
    	super(new ContainerPulverizier(InventoryPlayer, parTileEntity));
