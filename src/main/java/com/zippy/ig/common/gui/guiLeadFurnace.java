...
public class guiLeadFurnace extends GuiContainer{
	
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("textures/gui/container/furnace.png");
	private TileEntityLeadFurnace tileFurnace;

	public guiLeadFurnace(InventoryPlayer invPlayer, TileEntityLeadFurnace tile) {
		super(new ContainerLeadFurnace(invPlayer, tile));
